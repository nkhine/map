...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			t.iframeHTML += '</head><body id="' + bi + '" class="mceContentBody ' + bc + '" onload="window.parent.tinyMCE.get(\'' + t.id + '\').onLoad.dispatch(); window.parent.tinyMCE.get(\'' + t.id + '\').focus();"><br></body></html>';
